...
static int8 direction_relation = 0; // 第二大的目标点在第一大目标点的左侧还是右侧，0左侧， 1右侧

// searching logic
const uint32 SEARCHING_SPEED = -20;
static int32 searching_turn_err = 50;
static int32 searching_last_turn_time = 0;

// tracking logic
const uint32 TRACKING_SPEED = -30;

// closing logic
const uint32 CLOSE_SPEED = 0;
...
void handler_searching()
{
    ...
    // 1s后增加转向强度
    if (searching_last_turn_time + 500 < system_getval_ms())
    {
