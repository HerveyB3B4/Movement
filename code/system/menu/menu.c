...
MENU_TABLE Pid_TimeMenuTable[] = {
    {(uint8 *)"FA_Time", {.UINT32 = (uint32 *)&g_menu_manual_param.FrontControlTimeParameter[0]}, Param_Uint, {.ItemFunc = Menu_Null}},
    {(uint8 *)"FAV_Time", {.UINT32 = (uint32 *)&g_menu_manual_param.FrontControlTimeParameter[1]}, Param_Uint, {.ItemFunc = Menu_Null}},
    ...
    {(uint8 *)"SA_Time", {.UINT32 = (uint32 *)&g_menu_manual_param.SideControlTimeParameter[0]}, Param_Uint, {.ItemFunc = Menu_Null}},
    {(uint8 *)"SAV_Time", {.UINT32 = (uint32 *)&g_menu_manual_param.SideControlTimeParameter[1]}, Param_Uint, {.ItemFunc = Menu_Null}},
};
