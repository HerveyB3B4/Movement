...
float imu660rx_gyro_transition(int16 gyro_value)
{
    ...
    if (imu660rx_self_check_id == IMU660RX_CHIP_IDA)
    {
        ...
        case 0x04:
            gyro_data = (float)gyro_value / 262.4f;
