...
#define PWM_IN_PIN IfxGtm_TIM0_6_P14_3_IN
#define MOTOR_PWM_IN_PIN P14_3
#define PWM_TIM_INDEX IfxGtm_Tim_0
#define PWM_TIM_CHANNEL_INDEX IfxGtm_Tim_Ch_6
#define GTM_CLOCK IfxGtm_Cmu_Clk_1
#define GTM_PWM_IN_PRIORITY 80
