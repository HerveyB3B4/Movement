 ...
 * 2022-05-27       pudding
 *新增四个总线报错接管，新增总线报错时关闭所有中断及PWM输出
 ********************************************************************************************************************/
...
// #define DEBUG_UART_INDEX            (UART_0)            // 指定 debug uart
// 所使用的的串口 #define DEBUG_UART_BAUDRATE         (115200)            //
// 指定 debug uart 所使用的的串口波特率 #define DEBUG_UART_TX_PIN
// (UART0_TX_P14_0)    // 指定 debug uart 所使用的的串口引脚 #define
// DEBUG_UART_RX_PIN           (UART0_RX_P14_1)    // 指定 debug uart
...
#define IFX_CFG_CPU_TRAP_BE_HOOK(x)                                            \
    zf_log(0,                                                                  \
           "Memory access failure or Use an uninitialized peripheral, Locate " \
           "faults through debugging");                                        \
